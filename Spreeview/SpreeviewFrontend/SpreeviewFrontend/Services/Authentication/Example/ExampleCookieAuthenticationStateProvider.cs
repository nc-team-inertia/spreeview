...
public class ExampleCookieAuthenticationStateProvider(
    IHttpClientFactory httpClientFactory,
    ILogger<ExampleCookieAuthenticationStateProvider> logger)
    : AuthenticationStateProvider, IAccountManagement
{
    ...
    /// Special auth client.
    /// </summary>
    private readonly HttpClient httpClient = httpClientFactory.CreateClient("SpreeviewAPI");
